...
const hasClientLayout = computed(() => {
  return !Boolean(route.params?.bookUuid)
})

async function loadClient() {
  isLoadingClient.value = true

  await client.loadClient(route.params.clientUuid)
...
<template>
  <VLoader v-if="isLoadingClient" size="large" :active="true" grey>
    <div style="height: 100px">&nbsp;</div>
  </VLoader>
  <div v-else-if="!hasClientLayout" class="page-content-inner">
    <RouterView />
  </div>
      ...
      <div class="columns">
        ...
        <div class="column is-4">
          <div class="account-box is-navigation">
            <VBlock :title="client.client.label" center>
              <template #icon>
            ...
            <div class="account-menu">
              <RouterLink
                :to="`/company/${$route.params.companyUuid}/clients/${$route.params.clientUuid}/informations`"
              ...
              <RouterLink
                :to="`/company/${$route.params.companyUuid}/clients/${$route.params.clientUuid}/books/`"
                class="account-menu-item"
              >
                <i aria-hidden="true" class="lnil lnil-crown-alt"></i>
                <span>Carnets de liaison</span>
                <span class="end">
                  <i aria-hidden="true" class="fas fa-arrow-right"></i>
                </span>
              </RouterLink>
